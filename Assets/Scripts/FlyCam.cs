...
public class FlyCam : MonoBehaviour {
    ...
    public float shiftMult = 1.5f; // Multiplier while shift is held.
    public float turnSpeed= 0.25f; // Turn Speed multiplier.
    ...
    void LateUpdate () {
        ...
        if (Input.GetAxis("Mouse ScrollWheel") != 0) {
            moveDirection += myCamera.transform.forward * Input.GetAxis("Mouse ScrollWheel") * 50;
        }
